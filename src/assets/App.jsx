  ...
  return (
    ...
    className="space-y-8 bg-white p-4 font-sans text-center overflow-hidden">
      ...
      <div>
        ...
        <div className="mt-6 w-full relative animate__animated animate__fadeInUp">
          <a
            download
            href="/Snaptube.apk"
            className="bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"
          >
            Download 
          </a>
            <FiDownload className="absolute right-24 top-1 z-10" />
        </div>
      </div>
      <div>
      <img className="" src={demu} alt="" />
      </div>
      <p className="text-xl bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 text-transparent bg-clip-text bg-300% animate-gradient"> Download app YouTube Instagram Facebook WhatsApp and Twitter Video Download</p>
      {/* Social Icons */}
