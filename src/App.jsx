  ...
  return (
    ...
    className="space-y-8 bg-white p-4 font-sans text-center overflow-hidden">
      ...
      <div>
        ...
        <div className="mt-6 relative animate__animated animate__fadeInUp">
          <a
            download
            href="/Snaptube.apk"
            className="bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-8 py-2.5 me-2 mb-2"
          >
            Download 
          </a>
