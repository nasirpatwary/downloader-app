...
const SnaptubeDownloadPage = () => {
  return (
    <div className="max-w-5xl mx-auto space-y-8 bg-white p-4 md:p-8 font-sans text-center overflow-hidden">
      {/* Title & App Icon */}
      <div>
        <a download href={`${app}`} target="_blank" rel="noopener noreferrer">
          <img
      ...
      <div className="mt-2 md:w-44 mx-auto animate__animated animate__fadeInUp">
        <a
         download href={`${app}`} target="_blank" rel="noopener noreferrer"
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${demu})`,
        }}
      >
        <div className="hero-overlay bg-gradient-to-t from-black to-[rgba(31, 31, 31, 0)]"></div>
        <footer className="flex space-y-3 py-4 text-gray-300 md:p-4 flex-col footer-horizontal footer-center rounded lg:p-11">
          <h3>
            Easily download videos from YouTube Instagram Facebook WhatsApp and
          ...
          <aside>
            <p>
              Copyright © {new Date().getFullYear()} - Download the App – All
              Video Downloader
            </p>
          </aside>
        </footer>
